...
# 1. Load the data
housing = pd.read_csv(r"C:\Users\QAYAD ALI\qayad-project\1750577806322-housing\housing.csv")
...
##can cross validation be used to compare with linear regression and random forest if needed
